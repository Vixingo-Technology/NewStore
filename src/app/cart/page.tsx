...
export default function CartPage() {
            ...
            <div className="min-h-screen bg-linear-to-br from-black via-gray-900 to-black">
                <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-24">
                    <div className="text-center">
                        <div className="w-20 h-20 sm:w-24 sm:h-24 bg-linear-to-br from-gray-800 to-gray-900 rounded-full mx-auto mb-6 flex items-center justify-center">
                        ...
                        <p className="text-sm sm:text-base text-gray-300 mb-8 max-w-2xl mx-auto px-4">
                            ...
                            cart yet. Start shopping to discover amazing
                            jerseys!
                        </p>
                        <Link
                            href="/products"
                            className="inline-flex items-center gap-3 bg-linear-to-r from-yellow-200 to-yellow-100 text-black px-6 sm:px-8 py-3 sm:py-4 rounded-xl sm:rounded-2xl font-semibold hover:from-yellow-200 hover:to-yellow-100 transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl"
                        >
    ...
    return (
        <div className="min-h-screen bg-linear-to-br from-black via-gray-900 to-black">
            {/* Mobile Header */}
            <div className="lg:hidden bg-linear-to-br from-gray-900 to-black border-b border-gray-700 sticky top-0 z-10">
                <div className="px-4 py-4">
                    <div className="flex items-center justify-between">
                        ...
                        <div className="text-center">
                            <h1 className="text-lg font-bold text-yellow-200">
                                Cart
                            </h1>
            ...
            {/* Desktop Header */}
            <div className="hidden lg:block bg-linear-to-br from-gray-900 to-black border-b border-gray-700">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-12">
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 lg:gap-8">
                    ...
                    <div className="lg:col-span-2">
                        <div className="bg-linear-to-br from-gray-800 to-gray-900 rounded-2xl sm:rounded-3xl shadow-lg sm:shadow-xl border border-gray-700 overflow-hidden">
                            <div className="p-4 sm:p-6 lg:p-8 border-b border-gray-700 bg-linear-to-r from-gray-800 to-gray-900">
                                ...
                                {items.map((item, index) => (
                                    ...
                                    >
                                        <div className="flex flex-col sm:flex-row gap-4 sm:gap-6">
                                            {/* Product Image */}
                                            <div className="w-full sm:w-24 lg:w-32 h-24 sm:h-24 lg:h-32 bg-linear-to-br from-gray-700 to-gray-800 rounded-xl sm:rounded-2xl overflow-hidden shrink-0 shadow-md sm:shadow-lg mx-auto sm:mx-0">
                                                <YupooImage
                                            ...
                                            <div className="flex-1 min-w-0">
                                                ...
                                                <div className="flex items-center justify-between sm:justify-start gap-4">
                                                    ...
                                                    <div className="flex items-center bg-gray-700 rounded-lg sm:rounded-xl p-1 shadow-inner">
                                                        ...
                                                        <span className="px-3 sm:px-4 py-2 text-sm font-bold min-w-10 sm:min-w-12 text-center bg-gray-800 rounded-md sm:rounded-lg shadow-sm text-yellow-200 border border-gray-600">
                                                            {item.quantity}
                                                        </span>
                                                        <button
                                                            onClick={() =>
                    ...
                    <div className="lg:col-span-1">
                        <div className="bg-linear-to-br from-gray-800 to-gray-900 rounded-2xl sm:rounded-3xl shadow-lg sm:shadow-xl border border-gray-700 p-4 sm:p-6 lg:p-8 lg:sticky lg:top-8">
                            ...
                            <Link
                                href="/checkout"
                                className="w-full bg-linear-to-r from-yellow-200 to-yellow-100 text-black py-3 sm:py-4 px-6 rounded-xl sm:rounded-2xl font-bold hover:from-yellow-200 hover:to-yellow-100 transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl text-center block mb-4 text-sm sm:text-base"
                            >
                                Proceed to Checkout
                            </Link>
